...
class Block2(nn.Module):
    ...
    def __init__(self, size_in, size_hidden):
        ...
        self.fn5 = nn.Linear(size_hidden,size_hidden)
        self.fn6 = nn.Linear(size_hidden,size_hidden)
        self.fn7 = nn.Linear(size_hidden,size_hidden)
        #self.rbf1 = gaussian_layer([size_in,size_in], nn.Identity(),weight_init=torch.nn.init.xavier_uniform_)
        self.fn8 = nn.Linear(size_hidden,size_in)
    ...
    def forward(self, X):
        ...
        out = nn.Tanh()(self.fn6(out))
        out = nn.Tanh()(self.fn7(out))
        out = nn.Tanh()(self.fn8(out))
        out = out + X
