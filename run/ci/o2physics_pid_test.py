...
def main():
    ...
    shm_segment_size = 536870912
    option = f"-b --configuration json://{shlex.quote(str(config))} --aod-memory-rate-limit 2000000000 --shm-segment-size {shm_segment_size} --resources-monitoring 0 --min-failure-level error"
    command = (
